...
// Retrieve the expected scope from the context variable. This scope is defined in a property set named "check".
var expectedOperationScope = context.getVariable("flow.expectedOperationScope");

// Retrieve the expected scope from the context variable. This scope is defined in a property set named "simswap".
var expectedGlobalScope = context.getVariable("flow.expectedGlobalScope");
 ...
 * @param {string} expectedOperationScope - The expected scope to validate.
 * @param {string} expectedGlobalScope - The expected scope to validate.
 */
function validateScope(consentedScopes, expectedOperationScope, expectedGlobalScope) {
  if (!consentedScopes.includes(expectedOperationScope) && !consentedScopes.includes(expectedGlobalScope)) {
...
validateScope(consentedScopes, expectedOperationScope, expectedGlobalScope);