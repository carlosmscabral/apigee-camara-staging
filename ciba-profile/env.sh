...
export CIBA_TARGET_SERVER_URI="CIBA_TARGET_SERVER_URI" # e.g., "consent.com" (without https://, which will be assumed) This URI will be configured as a target server destination after input validation
